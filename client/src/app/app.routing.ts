...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'dashboard',
        loadChildren: () => import('./views/application/dashboard/dashboard.module').then(m => m.DashboardModule) ,
        canActivate: [AuthGuard]
      },
      {
        path: 'settings',
        loadChildren: () => import('./views/application/settings/settings.module').then(m => m.SettingModule)
      }
